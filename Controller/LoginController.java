...
public class LoginController {
	...
	// Update login details by email
	@PutMapping("login/{email}")
	public LoginEntity updateLogin(@PathVariable String email, @Valid @RequestBody LoginEntity LoginEntity)
			throws LoginNotFoundException {
		return loginServices.updateLogin(email, LoginEntity);
	}

	// Delete login details by email
